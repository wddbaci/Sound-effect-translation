...
<img width="1600" height="1256" alt="0c82bfb80833232dab2f073f7f12f55c" src="https://github.com/user-attachments/assets/783ea87b-2788-43f6-be02-cb77f8375e13" />
...
- **拖放支持**：直接将文件夹拖入窗口即可开始扫描（需安装 `tkinterdnd2`）「已集成」
...
### 1. 使用预打包的 macOS 应用
从 [Releases]([https://github.com/yourname/wavtranslator/releases](https://github.com/wddbaci/Sound-effect-translation/releases)) 下载最新版 `音效翻译.app`，拖入“应用程序”文件夹即可。
